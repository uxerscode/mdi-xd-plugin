...
compressJS('./components/iconItem.js', base + '/components/iconItem.js');
compressJS('./components/icons.js', base + '/components/icons.js');
compressJS('./components/search.js', base + '/components/search.js');
